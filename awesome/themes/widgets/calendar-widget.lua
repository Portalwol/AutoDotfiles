...
-- Dante Robinson removed not used themes and changed bg and fg colors
...
-- Dante Robinson set default theme to nord only, radius to 2, start sunday false, and set monnth buttons

    local theme = 'monokai'
    local placement = args.placement or 'top'
    local radius = 2
    local next_month_button = 3
